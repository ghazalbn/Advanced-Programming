...
namespace Exam1_cs
{
    public class MotorCycleDriver : IDriver, IPerson, ILocatable
    {
        ...
        public string VehicleColor() => $"{this.Firstname} {this.Lastname} has a {this.Color.Name.ToLower()} motor cycle!";

        public int CompareTo(object other)
        {
            MotorCycleDriver m = other as MotorCycleDriver;
